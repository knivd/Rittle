...
#include "../pic32mzef/plibs/usb/driver/usb/usbhs/drv_usbhs.h"
#include "../pic32mzef/plibs/usb/usb/usb_device.h"
#include "../pic32mzef/plibs/usb/usb/usb_device_cdc.h"
//#include "console.h"
...
const USB_DEVICE_DESCRIPTOR deviceDescriptor =
{
    ...
    0x04D8,                         // Vendor ID
    0x000A,                         // Product ID
    0x1905,                         // Device release number in BCD format
 ...
 *******************************************/
    const struct
    {
        uint8_t bLength;        // Size of this descriptor in bytes
        uint8_t bDscType;       // STRING descriptor type
        uint16_t string[6];		// uint16_t string[22];    // String
    }
    sd002 =
    {
        sizeof(sd002),
        USB_DESCRIPTOR_STRING,
		{'R','i','t','t','l','e'}	// {'S','i','m','p','l','e',' ','C','D','C',' ','D','e','v','i','c','e',' ','D','e','m','o'}
    };
...
const USB_DEVICE_INIT usbDevInitData =
{
    ...
    /* Pointer to the USB App Function. */
    .appUsbTask = &CheckUSB,
};
