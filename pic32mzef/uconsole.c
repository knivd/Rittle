...
char __attribute__((coherent)) __attribute__((aligned(16))) USB_TxOutBuf[512];
...
void __ISR(_USB_VECTOR, ipl4SRS) _IntHandlerUSBInstance0(void)
{
    DRV_USBHS_Tasks_ISR(sysObj.drvUSBObject);
}

void __ISR (_USB_DMA_VECTOR,ipl4SRS) _IntHandlerUSBInstance0_USBDMA ( void )
{
