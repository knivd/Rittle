...
/*******************************************************************
 *******************************************************************
  Private constants and type definition of CAN modules.
  *******************************************************************/
...
/*******************************************************************
 *******************************************************************
  Global constants and type definition of CAN modules.
  *******************************************************************/
...
/*******************************************************************
 *******************************************************************
  Private helper functions of CAN modules.
  *******************************************************************/

/*******************************************************************
Summary:
  This routine return the base address of each CAN module on the
  device.
  *******************************************************************/
extern __inline__ CAN_REGISTERS*  __attribute__((always_inline))
_canModules(CAN_MODULE module)
{
CAN_REGISTERS* ret = 0;

	if( CAN1 == module )
	{
		ret = (CAN_REGISTERS *)CAN1_BASE_ADDRESS;
	}
	else if( CAN2 == module )
	{
		ret = (CAN_REGISTERS *)CAN2_BASE_ADDRESS;
	}
...
/*******************************************************************
Summary:
  This routine configure the mapping between a filter and its filter control
  register. 
  *******************************************************************/	
extern __inline__ void __attribute__((always_inline))
_canFilterControlMap(CAN_FLTCON_BYTES* pflt, CAN_FILTER filter)
{

	switch(CAN_FILTER0)
	{
		case CAN_FILTER0:
			pflt->fltcon			= CAN_FILTER_CONTROL0;
			pflt->byteIndex		= 0;
			pflt->fltEnMask   = 0x80;
			break;
		...
		case CAN_FILTER1:
			pflt->fltcon      = CAN_FILTER_CONTROL0;
			pflt->byteIndex   = 1;
			pflt->fltEnMask   = 0x8000;
			break;

		case CAN_FILTER2:
			pflt->fltcon      = CAN_FILTER_CONTROL0;
			pflt->byteIndex   = 2;
			pflt->fltEnMask   = 0x800000;
			break;
			
		case CAN_FILTER3:
			pflt->fltcon      = CAN_FILTER_CONTROL0;
			pflt->byteIndex   = 3;
			pflt->fltEnMask   = 0x80000000;
			break;			
		
		case CAN_FILTER4:
			pflt->fltcon      = CAN_FILTER_CONTROL1;
			pflt->byteIndex   = 0;
			pflt->fltEnMask   = 0x80;
			break;
		...
		case CAN_FILTER8:
			pflt->fltcon      = CAN_FILTER_CONTROL2;
			pflt->byteIndex   = 0;
			pflt->fltEnMask   = 0x80;
			break;
		...
		case CAN_FILTER12:
			pflt->fltcon      = CAN_FILTER_CONTROL3;
			pflt->byteIndex   = 0;
			pflt->fltEnMask   = 0x80;
			break;
		...
		case CAN_FILTER16:
			pflt->fltcon      = CAN_FILTER_CONTROL4;
			pflt->byteIndex   = 0;
			pflt->fltEnMask   = 0x80;
			break;
		...
		case CAN_FILTER20:
			pflt->fltcon      = CAN_FILTER_CONTROL5;
			pflt->byteIndex   = 0;
			pflt->fltEnMask   = 0x80;
			break;
		...
		case CAN_FILTER24:
			pflt->fltcon      = CAN_FILTER_CONTROL6;
			pflt->byteIndex   = 0;
			pflt->fltEnMask   = 0x80;
			break;
		...
		case CAN_FILTER28:
			pflt->fltcon      = CAN_FILTER_CONTROL7;
			pflt->byteIndex   = 0;
			pflt->fltEnMask   = 0x80;
			break;
...
/*******************************************************************
 *******************************************************************
  Global functions of CAN modules.
  *******************************************************************/
...
/********************************************************************************************
  ...
  ********************************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANAssignMemoryBuffer(CAN_MODULE module, void* buffer, UINT sizeInBytes)
{
CAN_REGISTERS* canRegisters;

    canRegisters = _canModules(module);
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANSetOperatingMode(CAN_MODULE module, CAN_OP_MODE opmode)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  Remarks:
    None.
  *****************************************************************************/
extern __inline__ CAN_OP_MODE __attribute__((always_inline)) 
 CANGetOperatingMode(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANEnableFeature(CAN_MODULE module, CAN_MODULE_FEATURES features, BOOL enable)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANDeviceNetFilter(CAN_MODULE module, CAN_DNET_FILTER_SIZE dncnt)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANSetTimeStampValue(CAN_MODULE module,    UINT value)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  Remarks:
    None.
  *****************************************************************************/
extern __inline__ UINT __attribute__((always_inline)) 
CANGetTimeStampValue(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANSetTimeStampPrescalar(CAN_MODULE module,    UINT prescalar)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANEnableModule(CAN_MODULE module, BOOL enable )
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANSetSpeed(CAN_MODULE module, const CAN_BIT_CONFIG * canBitConfig,
                        UINT32 sysClock, UINT32 canBusSpeed )
{
UINT totalTq;
UINT prescalar;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANResetChannel(CAN_MODULE module, CAN_CHANNEL channel )
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ BOOL __attribute__((always_inline)) 
CANIsChannelReset(CAN_MODULE module, CAN_CHANNEL channel )
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANUpdateChannel(CAN_MODULE module, CAN_CHANNEL channel)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANEnableModuleEvent(CAN_MODULE module, CAN_MODULE_EVENT flags, BOOL enable)
{
UINT32 mask;
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANClearModuleEvent(CAN_MODULE module, CAN_MODULE_EVENT flags)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  Example:
    ...
    // on Channel 3 and disable all RX events on
    // on Channel 4.
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANEnableChannelEvent(CAN_MODULE module, CAN_CHANNEL channel,CAN_CHANNEL_EVENT flags, BOOL enable)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ CAN_MODULE_EVENT __attribute__((always_inline)) 
CANGetModuleEvent(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ CAN_EVENT_CODE __attribute__((always_inline)) 
CANGetPendingEventCode(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ CAN_CHANNEL_MASK __attribute__((always_inline)) 
CANGetAllChannelEventStatus(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ CAN_CHANNEL_MASK __attribute__((always_inline)) 
CANGetAllChannelOverflowStatus(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  Description:
    ...
    for a specific event(s). Channel events are affected regardless of whether the
  ...
  *****************************************************************************/
extern __inline__ CAN_CHANNEL_EVENT __attribute__((always_inline)) 
CANGetChannelEvent(CAN_MODULE module, CAN_CHANNEL channel)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANClearChannelEvent(CAN_MODULE module, CAN_CHANNEL channel, CAN_CHANNEL_EVENT events)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANConfigureChannelForTx(CAN_MODULE module,CAN_CHANNEL channel, UINT channelSize,
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANAbortPendingTx(CAN_MODULE module, CAN_CHANNEL channel)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANFlushTxChannel(CAN_MODULE module, CAN_CHANNEL channel)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ CAN_TX_CHANNEL_CONDITION __attribute__((always_inline)) 
CANGetTxChannelCondition(CAN_MODULE module, CAN_CHANNEL channel)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ CANTxMessageBuffer* __attribute__((always_inline)) 
CANGetTxMessageBuffer(CAN_MODULE module, CAN_CHANNEL channel)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ BOOL __attribute__((always_inline)) 
CANIsTxAborted(CAN_MODULE module, CAN_CHANNEL channel)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  Returns:
    ...
    CAN message. If the receive channel is a data-only channel, the message will only
  ...
  *****************************************************************************/
extern __inline__ CANRxMessageBuffer* __attribute__((always_inline)) 
CANGetRxMessage(CAN_MODULE module, CAN_CHANNEL channel)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANConfigureChannelForRx(CAN_MODULE module, CAN_CHANNEL channel, UINT32 channelSize,
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANConfigureFilterMask(CAN_MODULE module, CAN_FILTER_MASK mask, UINT32 maskbits,
                                CAN_ID_TYPE maskType, CAN_FILTER_MASK_TYPE mide)
{
UINT sid;
UINT eid;
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANConfigureFilter(CAN_MODULE module, CAN_FILTER filter, UINT32 id, CAN_ID_TYPE filterType)
{
UINT sid;
UINT eid;
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ void __attribute__((always_inline)) 
CANEnableFilter(CAN_MODULE module, CAN_FILTER filter, BOOL enable)
{
UINT mask;
CAN_FILTER_CONTROL fltcon;
CAN_REGISTERS* canRegisters;
CAN_FLTCON_BYTES flt;

    canRegisters = _canModules(module);
    _canFilterControlMap(&flt, filter);
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ CAN_FILTER __attribute__((always_inline)) 
CANGetLatestFilterHit(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ BOOL __attribute__((always_inline)) 
CANIsFilterDisabled(CAN_MODULE module, CAN_FILTER filter)
{
UINT mask;
CAN_FILTER_CONTROL fltcon;
UINT maskResult;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ UINT __attribute__((always_inline)) 
CANGetRxErrorCount(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ UINT __attribute__((always_inline)) 
CANGetTxErrorCount(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
...
/*******************************************************************************
  ...
  *****************************************************************************/
extern __inline__ CAN_ERROR_STATE __attribute__((always_inline)) 
CANGetErrorState(CAN_MODULE module)
{
CAN_REGISTERS* canRegisters;
