...
#include "../usb_device_cdc_local.h"
...
)
{
    ...
    if (iCDC >= USB_DEVICE_CDC_INSTANCES_NUMBER)
    {
        ...
        SYS_ASSERT(0, "USB Device CDC: Invalid index");
        return;
    }
        ...
        case USB_DESCRIPTOR_INTERFACE:
            {
                ...
                else
                {
                    ...
                    SYS_ASSERT(0, "USB Device CDC: Invalid interface presented to CDC " );
                }
        ...
        case USB_DESCRIPTOR_ENDPOINT:
            {
                ...
                else
                {
                    ...
                    SYS_ASSERT(0, "USB Device CDC: Cannot handle this endpoint type" );
                    break;
                }
...
void _USB_DEVICE_CDC_Deinitialization ( SYS_MODULE_INDEX iCDC )
{
    ...
    if(iCDC >= USB_DEVICE_CDC_INSTANCES_NUMBER)
    {
        SYS_ASSERT(0, "USB Device CDC: Invalid instance");
        return;
    } 
...
)
{
    ...
    {
        /* invalid CDC index */
        SYS_ASSERT(0, "USB Device CDC: Invalid CDC index" );
        return;
    }
