...
/* Default definition used for all API dispatch functions */
    ...
    #define PLIB_INLINE_API extern __inline__ __attribute__((always_inline)) 
#endif

/* Default definition used for all other functions */
#ifndef PLIB_INLINE
    #define PLIB_INLINE extern __inline__ __attribute__((always_inline)) 
#endif
...
typedef enum {
    USBHS_INT_SOURCE_USB_1 = 132,
    USBHS_INT_SOURCE_USB_1_DMA = 133  
} USBHS_INT_SOURCE;
...
PLIB_INLINE_API void PLIB_USBHS_InterruptSourceEnable(USBHS_MODULE_ID index , USBHS_INT_SOURCE source)
{
    USBHS_InterruptSourceEnable_Default(index , source);
}

PLIB_INLINE_API void PLIB_USBHS_InterruptSourceDisable(USBHS_MODULE_ID index , USBHS_INT_SOURCE source)
{
    USBHS_InterruptSourceDisable_Default(index , source);
}

PLIB_INLINE_API bool PLIB_USBHS_INT_SourceDisable(USBHS_MODULE_ID index , USBHS_INT_SOURCE source)
{
    bool intSrcStatus;
    ...
    intSrcStatus = USBHS_InterruptSourceIsEnabled_Default(USBHS_ID_0 , source);

    /* disable the interrupts */
    USBHS_InterruptSourceDisable_Default(USBHS_ID_0 , source);
...
PLIB_INLINE_API void PLIB_USBHS_InterruptSourceFlagClear(USBHS_MODULE_ID index , USBHS_INT_SOURCE source)
{
    USBHS_InterruptSourceFlagClear_Default(index , source);
}

PLIB_INLINE_API bool PLIB_USBHS_InterruptSourceFlagGet(USBHS_MODULE_ID index , USBHS_INT_SOURCE source)
{
    return USBHS_InterruptSourceFlagGet_Default(index , source);
}

PLIB_INLINE_API void PLIB_USBHS_InterruptSourceFlagSet(USBHS_MODULE_ID index , USBHS_INT_SOURCE source)
{
    USBHS_InterruptSourceFlagSet_Default(index , source);
}
