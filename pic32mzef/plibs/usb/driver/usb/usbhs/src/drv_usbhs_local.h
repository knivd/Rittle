...
#include "../drv_usbhs.h"
#include "drv_usbhs_variant_mapping.h"
#include "../../../../osal/osal.h"
...
typedef struct _DRV_USBHS_OBJ_STRUCT
{
    ...
    _DRV_USBHS_FOR_DYNAMIC(USBHS_INT_SOURCE, interruptSource);

    /* Interrupt source for USB DMA module */
    _DRV_USBHS_FOR_DYNAMIC(USBHS_INT_SOURCE, interruptSourceUSBDma);
    ...
    DRV_USB_TMR_HANDLE timerHandle;
